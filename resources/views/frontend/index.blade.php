        ...
        <div class="heroHomeSwiper swiper">
            <div class="swiper-wrapper flex !items-stretch">
              ...
              h-72 xs:h-80 sm:h-[22rem] md:h-[24rem] lg:h-full">
                            <div
                                class="absolute inset-x-0 h-3/5 bottom-0 bg-gradient-to-br from-primary-600 to-orange-400 rounded-xl">
                            </div>
                            <div class="h-full w-full relative px-2 pb-2" data-hero-slide-image>
                                <img src="images/image0.webp" alt="" width="1950"
                    ...
                    <div class="appcontainer h-full flex flex-col mdmid:flex-row gap-3 md:gap-5  relative pt-4">
                        <div class="pt-7 md:pt-12 pb-28 mdmid:w-1/2 mdmid:flex-1 order-2 lg:order-1">
                            <h1 data-hero-slide-title
                                ...
                                <span class="bg-clip-text bg-gradient-to-tr from-red-400 to-primary-600">le progrès
                                    social.</span>
                            </h1>
              ...
              h-72 xs:h-80 sm:h-[22rem] md:h-[24rem] lg:h-full">
                            ...
                            <div class="h-full w-full relative px-2 pb-2" data-hero-slide-image>
                                <img src="images/image1.webp" alt="" width="1950"
                                    class="h-full w-full rounded-xl object-cover">
                            </div>
                        </div>
                    </div>
              ...
              h-72 xs:h-80 sm:h-[22rem] md:h-[24rem] lg:h-full">
                            ...
                            <div class="h-full w-full relative px-2 pb-2" data-hero-slide-image>
                                <img src="/images/image2.webp" alt="" width="1950"
                                    class="h-full w-full rounded-xl object-cover">
                            </div>
                        </div>
                    </div>
        ...
        <div class="swiper-control-navigation">
            <div class="appcontainer flex items-center w-full gap-3 relative z-30">
                <div class="flex items-center gap-4 bg-gray-100 rounded-xl p-1.5">
                    <button class="swip-prev-homeslide btnswiphero">
                    ...
                    <button class="swip-next-homeslide btnswiphero">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" class="w-5 h-5">
                            <path fill-rule="evenodd"
        ...
        <div class="md:w-1/2 flex-1 md:py-3 xl:py-6">
            ...
            <div class="pt-8 space-y-2">
                <p class="text-paragraph">
                    Notre pays a le potentiel d’être un endroit où chaque citoyen peut prospérer et atteindre ses
                    objectifs. Mais pour y parvenir, nous devons travailler ensemble pour construire une société plus
                    juste et équitable.
                </p>
                <p class="text-paragraph">
                    En tant que citoyens, nous avons le pouvoir de faire la différence en votant pour des dirigeants qui
                    partagent notre vision d’un avenir meilleur. Nous pouvons également nous impliquer dans nos
                    communautés en faisant du bénévolat et en soutenant des initiatives locales.
                </p>
            </div>
    ...
    <div class="appcontainer relative">
        <div class="max-w-3xl mx-auto text-center">
            <div class="">
                ...
                <p class="text-paragraph pt-5">
                    Pour garantir les droits de tous les citoyens, nous devons travailler ensemble et construire un pays
                    meilleur pour nos enfants. Nous devons donc prendre des initiatives appropriées.
                </p>
            </div>
        </div>
        <div class="pt-10 md:pt-12 lg:pt-14 grid xs:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-8 md:gap-6 lg:gap-10">
            ...
            <div class="card-withicon">
                <div class="box-img">
                    <span class="imgbox">
                        <img src="/icons/democraty.png" alt="icon peace" width="240" height="240" class="icon">
                    </span>
                </div>
                <div class="content">
                    <h3 class="title-ci">
            ...
            <div class="card-withicon">
                <div class="box-img">
                    <span class="imgbox">
                        <img src="/icons/equality.png" alt="icon peace" width="240" height="240" class="icon">
                    </span>
                </div>
                <div class="content">
                    <h3 class="title-ci">
            ...
            <div class="card-withicon">
                <div class="box-img">
                    <span class="imgbox">
                        <img src="/icons/diversity.png" alt="icon peace" width="240" height="240" class="icon">
                    </span>
                </div>
                <div class="content">
                    <h3 class="title-ci">
            ...
            <div class="card-withicon">
                <div class="box-img">
                    <span class="imgbox">
                        <img src="/icons/peace.png" alt="icon peace" width="240" height="240" class="icon">
                    </span>
                </div>
                <div class="content">
                    <h3 class="title-ci">
            ...
            <div class="card-withicon">
                <div class="box-img">
                    <span class="imgbox">
                        <img src="/icons/security.png" alt="icon peace" width="240" height="240" class="icon">
                    </span>
                </div>
                <div class="content">
                    <h3 class="title-ci">
            ...
            <div class="card-withicon">
                <div class="box-img">
                    <span class="imgbox">
                        <img src="/icons/justice.png" alt="icon peace" width="240" height="240" class="icon">
                    </span>
                </div>
                <div class="content">
                    <h3 class="title-ci">
...
<section class="a-section">
    <div class="appcontainer section-d-2 relative">
        ...
        <div class="md:w-1/2 flex-1 md:py-6 lg:py-10 xl:py-12">
            ...
            <ul role="listitem" class="pt-8 space-y-2 grid gap-y-3 gap-x-4 sm:gap-x-6 md:gap-x-5 lg:gap-x-8">
                <li class="check-item-lst">
                    <img src="/icons/checkIcoFill.png" alt="check fill" width="20" height="20" class="w-6 h-6">
                    La promotion de la démocratie et de la participation citoyenne à tous les niveaux de gouvernement.
                </li>
                <li class="check-item-lst">
                    <img src="/icons/checkIcoFill.png" alt="check fill" width="20" height="20"
                        class="w-4 xs:w-5 h-4 xs:h-5 sm:w-6 sm:h-6">
                    La lutte contre la corruption et la promotion de la transparence et de la responsabilité dans tous
                    les domaines de la vie politique.
                </li>
                <li class="check-item-lst">
                    <img src="/icons/checkIcoFill.png" alt="check fill" width="20" height="20"
                        class="w-4 xs:w-5 h-4 xs:h-5 sm:w-6 sm:h-6">
                    La défense des droits fondamentaux des citoyens, y compris la liberté d'expression et de la presse,
                    la protection des minorités et l'égalité des chances pour tous.
                </li>
            </ul>
            <div class="flex flex-wrap items-center gap-3 pt-10">
        ...
        <div class="section-bloc-with-image">
            ...
            <div
                class="card hidden xs:flex xs:flex-col xs:w-64 md:w-72 lg:w-3/5 absolute -bottom-10 md:bottom-6 -left-2 md:-left-6 xl:-left-12">
                ...
                <div
                    ...
                    <div class="grid grid-cols-3 gap-4 sm:gap-6 md:gap-5 lg:gap-6">
                        <div
                            ...
                            <span
                                class="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-bold text-gray-800 px-4 py-3">25</span>
                        ...
                        <div
                            class="flex flex-col bg-white backdrop-filter bg-opacity-80 backdrop-blur-md text-center rounded-lg overflow-hidden">
                            <span
                                class="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-bold text-gray-800 px-4 py-3">10</span>
                ...
                <ul role="listitem" class="flex flex-col space-y-2.5">
                    <li class="flex">
                        <a href="#" class="group event-like-lst-item">
                            ...
                            <p>
                                Lorem ipsum dolor, sit amet consectetur adipisicing elit. Consectetur aperiam eligendi
                                doloremque
                                optio, facere iure blanditiis totam provident? Adipisci facere cum saepe iste
                                repellendus sunt
            ...
            <div class="swiper-wrapper pb-8">
                <div class="swiper-slide !bg-transparent">
                    <div class="card card-blog group">
                        <div class="relative">
                            <img src="/images/image1.webp" alt="images present" width="1980" height="auto"
                                class="image">
                ...
                <div class="swiper-slide !bg-transparent">
                    <div class="card card-blog group">
                        <div class="relative">
                            <img src="/images/image5.webp" alt="images present" width="1980" height="auto"
                                class="image">
                            <div class="absolute bottom-2 right-2 bg-primary-600 text-white rounded-md px-3">
                                12-12-2022
                            </div>
                ...
                <div class="swiper-slide !bg-transparent">
                    <div class="card card-blog group">
                        <div class="relative">
                            <img src="/images/image6.webp" alt="images present" width="1980" height="auto"
                                class="image">
                            <div class="absolute bottom-2 right-2 bg-primary-600 text-white rounded-md px-3">
                                12-12-2022
                            </div>
    ...
    <div class="appcontainer">
        <div class="text-center max-w-2xl md:max-w-2xl lg:max-w-3xl mx-auto">
            ...
            <p class="mb-10 text-base md:text-lg text-gray-600">
                Nous croyons en un avenir juste et équitable pour tous, et nous avons besoin de votre aide pour y
                parvenir. Rejoignez-nous dès aujourd'hui et ensemble, nous pourrons faire la différence.
            </p>
